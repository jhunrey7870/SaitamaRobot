...
PM_START_TEXT = """
Hi {}, my name is {}! 
I am Telegram Group Managebot that can help you to manage your group send /help right now to know more how to use me!
"""

HELP_STRINGS = """
Hey there! My name is *{}*.
Im Helpful bot to help admins to manage telegram groups feel free to /help to know more :)
...
SAITAMA_IMG = "https://telegra.ph/file/b0421101dd53ba592e6da.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
TerminatorBot is hosted on Jhunrey"s MediaTek Server and doesn't require any donations as of now but \
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="☑️ Add TerminatorBot to your group",
                     ...
                     [
                         InlineKeyboardButton(
                             text="🚑 Support Group",
                             url=f"http://t.me/terminatorbot6969"),
                     ],
                      [
                             InlineKeyboardButton(
                     ...
                     [
                         InlineKeyboardButton(
                             text="🗄 Source code",
                             url="https://github.com/jhunrey7870/TerminatorBot")
                     ]]))
    else:
